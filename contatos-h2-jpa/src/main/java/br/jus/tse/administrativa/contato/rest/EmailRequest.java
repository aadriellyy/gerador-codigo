...
public class EmailRequest {
    ...
    public Email trasforma(ContatoPessoal dono){
        Email email = new Email(this.email, dono); 
        return email;
    }
    public Email trasforma(Long id,ContatoPessoal dono){
        Email email = new Email(id,this.email, dono); 
        return email;
    }
